...
export const COMPANIONS: Record<CompanionName, CompanionInfo> = {
  Abelard: {
    ...
    portraitUrl: '/images/companions/abelard.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Argenta: {
    ...
    portraitUrl: '/images/companions/argenta.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
    role: 'Ranged Damage',
  },
  Idira: {
    ...
    portraitUrl: '/images/companions/idira.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Pasqal: {
    ...
    portraitUrl: '/images/companions/pasqal.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Cassia: {
    ...
    portraitUrl: '/images/companions/cassia.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
    role: 'Support / Buffer',
  },
  Heinrix: {
    ...
    portraitUrl: '/images/companions/heinrix.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Jae: {
    ...
    portraitUrl: '/images/companions/jae.jpg',
    recruitmentAct: 2,
    startingLevel: 12,
  ...
  Yrliet: {
    ...
    portraitUrl: '/images/companions/yrliet.jpg',
    recruitmentAct: 2,
    startingLevel: 16,
  ...
  Marazhai: {
    ...
    portraitUrl: '/images/companions/marazhai.jpg',
    recruitmentAct: 3,
    startingLevel: 26,
  ...
  Ulfar: {
    ...
    portraitUrl: '/images/companions/ulfar.png',
    recruitmentAct: 4,
    startingLevel: 36,
