...
export const COMPANIONS: Record<CompanionName, CompanionInfo> = {
  Abelard: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/seneschal.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Argenta: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/sister_argenta_companion_rogue_trader_wiki_guide200px.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
    role: 'Ranged Damage',
  },
  Idira: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/idira_companion_rogue_trader_wiki_guide200px.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Pasqal: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/pasqal_companion_rogue_trader_wiki_guide200px.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Cassia: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/cassia_companion_rogue_trader_wiki_guide200px.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
    role: 'Support / Buffer',
  },
  Heinrix: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/heinrix_companion_rogue_trader_wiki_guide200px.jpg',
    recruitmentAct: 1,
    startingLevel: 1,
  ...
  Jae: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/jae.jpg',
    recruitmentAct: 2,
    startingLevel: 12,
  ...
  Yrliet: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/yrliet.jpg',
    recruitmentAct: 2,
    startingLevel: 16,
  ...
  Marazhai: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/marazhai.jpg',
    recruitmentAct: 3,
    startingLevel: 26,
  ...
  Ulfar: {
    ...
    portraitUrl: 'https://roguetrader.wiki.fextralife.com/file/Rogue-Trader/skjald.png',
    recruitmentAct: 4,
    startingLevel: 36,
